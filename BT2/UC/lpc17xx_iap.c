...
/*********************************************************************//**
 * @brief		   Escribir en posición de memoria
 *
 * @param[in] posicion.
 * @param[in] tamaño dato.
 * @param[in] dato.
 *
 * @return 	None.
 *
...
int escribir_posicion_char(uint16_t posicion, uint16_t tamanio, char *dato)
{
	uint16_t i;
	uint8_t *ptr;
	int result = 0;
